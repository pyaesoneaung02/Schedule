...
class UserController extends Controller
{
    ...
    */
        ...
        /*
    |--------------------------------------------------------------------------
    | VALIDATE SEMESTER & SECTION
    |--------------------------------------------------------------------------
    */

        if (! $semesterID) {
            abort(404, 'Semester ID is required.');
        }

        if (! $sectionID) {
            abort(404, 'Section ID is required.');
        }
    ...
    */
        ...
        $semesters = Semesters::findOrFail($semesterID);

        $sections = Sections::findOrFail($sectionID);
    ...
    */
        ...
        return $pdf->download(
            'TimeTable-' . $yearData->name . '-Section-' . $sections->name . '.pdf'
        );
