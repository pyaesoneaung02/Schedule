...
<div class="container-fluid">
    ...
    <div class="mb-4">
        ...
        <p class="mb-0 font-weight-bold" style="color: #000 !important;">
            Create and manage class time schedules.
        </p>
        ...
        <div class="col-lg-4">
            ...
            <div class="border-0 shadow-sm card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('time.create')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                name="timeName"
                                value="{{ old('timeName')}}"
                                class="form-control font-weight-bold @error('timeName') is-invalid @enderror"
                                placeholder="Time Name..." style="color: #000 !important;">
                                ...
                                @forelse ($times as $index => $item)
                                    ...
                                    <tr class="font-weight-bold" style="color: #000 !important;">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('time.updatePage', $item->id)}}"
