    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between my-2">
            <div class="mb-4 d-sm-flex align-items-center justify-content-between">
                <h1 class="mb-0 text-gray-800 h3">Teachings List</h1>
            </div>
        ...
        <div class="">
            <div class="row">
                <div class="col">
                            ...
                            @if (count($teachings) != 0)
                                @foreach ($teachings as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('teaching.updatePage', $item->id) }}" class="btn btn-sm btn-outline-primary"><i
                    ...
                    <span class="d-flex justify-content-end">{{$teachings->links()}}</span>
                </div>
            </div>
        </div>
