...
@section('content')
    <div class="container">
        <div class="row">
            <div class="p-3 text-white rounded shadow-sm col-6 offset-3 card bg-info mt-3">
                <form action="{{ route('schedule.update', $schedule->id)}}" method="POST">
                    ...
                    <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="yearID" class="form-control @error('yearID') is-invalid @enderror">
                                        ...
                                        @foreach ($years as $item)
                                            <option value="{{ $item->id }}" @if (old('yearID', $schedule->year_id) == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('yearID')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="majorID" class="form-control  @error('majorID') is-invalid @enderror">
                                        ...
                                        @foreach ($majors as $item)
                                            <option value="{{ $item->id }}" @if (old('majorID', $schedule->major_id) == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('majorID')
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <select name="roomID" class="form-control @error('roomID') is-invalid @enderror">
                                        ...
                                        @foreach ($rooms as $item)
                                            <option value="{{ $item->id }}" @if (old('roomID', $schedule->room_id) == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('roomID')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="subjectID" class="form-control @error('subjectID') is-invalid @enderror">
                                        ...
                                        @foreach ($subjects as $item)
                                            <option value="{{ $item->id }}" @if (old('subjectID', $schedule->subject_id) == $item->id) selected @endif>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    @foreach ($teachers as $item)
                                            <option value="{{ $item->id }}" @if (old('teacherID', $schedule->teacher_id) == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('teacherID')
                                ...
                                <div class="mb-3">
                                    ...
                                    @foreach ($days as $item)
                                            <option value="{{ $item->id }}" @if (old('dayID', $schedule->day_id) == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('dayID')
                                ...
                                <div class="mb-3">
                                    ...
                                    @foreach ($times as $item)
                                            <option value="{{ $item->id }}" @if (old('timeID', $schedule->time_id) == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('timeID')
                        ...
                        <div class="mb-3 mt-2">
                            <input type="submit" value="Update Schedule" class="rounded shadow-sm btn btn-danger w-100">
                        </div>
                        <div class="mb-3 mt-2">
