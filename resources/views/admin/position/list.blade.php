...
<div class="container-fluid">
    ...
    <div class="mb-4">
        ...
        <h2 class="font-weight-bold" style="color: #000 !important;">
            <i class="mr-2 fa-solid fa-user-tie text-primary"></i>
            Rank Management
        </h2>
                    ...
                    <form action="{{ route('position.create')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                class="form-control font-weight-bold @error('positionName') is-invalid @enderror"
                                placeholder="Rank Name..." style="color: #000 !important;">
                                ...
                                @forelse ($positions as $index => $item)
                                    ...
                                    <tr class="font-weight-bold" style="color: #000 !important;">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('position.updatePage', $item->id)}}"
                                            ...
                                            <a href="{{ route('position.delete', $item->id)}}"
