...
@section('content')
    <div class="container-fluid">
        ...
        <div class="mb-4">
            ...
            <p class="font-weight-bold" style="color: #000 !important;">Create and manage day names.</p>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('day.create') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold" style="color: #000 !important;">Day Name</label>

                                <input type="text" name="dayName" value="{{ old('dayName') }}"
                                    class="form-control font-weight-bold @error('dayName') is-invalid @enderror"
                                    placeholder="Enter day name" style="color: #000 !important;">
