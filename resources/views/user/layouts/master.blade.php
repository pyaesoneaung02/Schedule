...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .ucsm-navbar .nav-link:hover .nav-menu-icon {
        ...
        .ucsm-account-link .nav-menu-icon {
        ...
        main {
            ...
            padding:
                var(--navbar-height) 0 0 !important;
        ...
        @media (max-width: 991px) {
            ...
            .ucsm-navbar .navbar-toggler:focus {
